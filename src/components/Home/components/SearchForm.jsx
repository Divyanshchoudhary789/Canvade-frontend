...
const SelectField = memo(function SelectField({
  ...
  return (
    <div className="w-full">
      <label
        htmlFor={name}
        className="mb-1 block text-xs sm:text-[13px] font-bold text-slate-900 tracking-tight"
      >
        {label}
      </label>
      <div className="relative w-full">
        <select
          ...
          onChange={onChange}
          onBlur={onBlur}
          className="w-full rounded-xl border border-gray-200 bg-white px-3 sm:px-3.5 py-2 sm:py-2.5 pr-8 text-xs sm:text-[13px] text-slate-800 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none transition-all duration-200 appearance-none shadow-xs cursor-pointer"
          aria-label={label}
        >
  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        } bg-white px-3 sm:px-3.5 py-2 sm:py-2.5 text-xs sm:text-[13px] text-slate-900 placeholder:text-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none transition-all duration-200 shadow-xs`}
        aria-label={label}
        aria-invalid={!!error}
...
const SearchForm = memo(function SearchForm({
  ...
  return (
    <form
      ...
      className="w-full rounded-2xl bg-white p-4 sm:p-5 lg:p-6 shadow-xl border border-gray-100/80 transition-all duration-300"
      noValidate
    ...
    >
      <div className="flex flex-col gap-3 sm:gap-3.5">
        ...
        <div className="flex flex-col items-start gap-2 pt-1.5 sm:pt-2">
          <button
            type="submit"
            className="w-full sm:w-auto px-8 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm shadow-md hover:shadow-lg transition-all duration-300 active:scale-[0.98] cursor-pointer"
